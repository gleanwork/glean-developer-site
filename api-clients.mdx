...
<CardGroup cols={2}>
  <Card title="Python" icon="python" href="https://github.com/gleanwork/api-client-python">
    Python API client for Glean
  </Card>
  <Card title="TypeScript" icon="js" href="https://github.com/gleanwork/api-client-typescript">
    TypeScript/JavaScript API client for Glean
  </Card>
  <Card title="Go" icon="golang" href="https://github.com/gleanwork/api-client-go">
    Go API client for Glean
  </Card>
  <Card title="Java" icon="java" href="https://github.com/gleanwork/api-client-java">
