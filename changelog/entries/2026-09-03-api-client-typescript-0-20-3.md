---
title: 'api-client-typescript v0.20.3'
categories: ['API Clients']
---

Api-client-typescript v0.20.3 includes 54 additions.
...
- [Release notes](https://github.com/gleanwork/api-client-typescript/releases/tag/v0.20.3)
