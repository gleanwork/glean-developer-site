---
title: 'api-client-typescript v0.20.0'
categories: ['API Clients']
---

Api-client-typescript v0.20.0 includes 1 breaking removal, 1 change.
...
- [Release notes](https://github.com/gleanwork/api-client-typescript/releases/tag/v0.20.0)
