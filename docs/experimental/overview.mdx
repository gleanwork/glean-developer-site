...
<CardGroup cols={2}>
  <Card title="Experimental" icon="Zap" color="#d97706">
...
## How You'll Know an Endpoint Is Experimental

<CardGroup cols={2}>
  <Card title="Sidebar Tag" icon="Tag" color="#d97706">
    Experimental endpoints are marked with an orange **Experimental** tag in the API reference sidebar.
  </Card>
  <Card title="Page Banner" icon="AlertCircle" color="#d97706">
    Each experimental endpoint shows a banner at the top of its reference page linking back to this guide.
  </Card>
</CardGroup>
