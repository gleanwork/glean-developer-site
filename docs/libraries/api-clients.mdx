...
:::info
**Versioning**: Starting with `1.0.0`, the libraries follow a compatibility policy based on Semantic Versioning. Read the [API client versioning policy](/libraries/api-clients/versioning) before choosing a version range for production.
:::
