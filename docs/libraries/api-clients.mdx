...
<CardGroup cols={2}>
  ...
  >
    Full-featured Python client with framework integrations for FastAPI, Django,
    and Streamlit
  </Card>
  <Card
    title="TypeScript"
  ...
  >
    Type-safe client for Node.js and browser applications with React, Next.js,
    and Express examples
  </Card>
  <Card title="Go" icon="go" iconSet="glean" href="/libraries/api-clients/go">
    Idiomatic Go client with concurrency patterns and framework integrations for
    Gin and Echo
  </Card>
  <Card
    title="Java"
  ...
  >
    Enterprise-ready Java client with Spring Boot integration and reactive
    programming support
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Web SDK" icon="Code" href="/libraries/web-sdk/overview">
...
<CardGroup cols={3}>
  ...
  <Card title="Agent Building" icon="User" href="/guides/agents/overview">
