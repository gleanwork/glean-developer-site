...
<Tabs>
  <TabItem value="npm" label="npm">
    ```bash snippet=typescript/snippet-01.sh
    npm install @gleanwork/api-client
    ```
  </TabItem>
  <TabItem value="yarn" label="yarn">
    ```bash snippet=typescript/snippet-02.sh
    yarn add @gleanwork/api-client
    ```
  </TabItem>
  <TabItem value="pnpm" label="pnpm">
    ```bash snippet=typescript/snippet-03.sh
...
```typescript snippet=typescript/snippet-04.ts
...
```typescript snippet=typescript/snippet-05.ts
// Simple chat
...
```typescript snippet=typescript/snippet-06.ts
...
```typescript snippet=typescript/snippet-07.ts
...
```typescript snippet=typescript/snippet-08.ts
...
```typescript snippet=typescript/snippet-09.ts
...
```typescript snippet=typescript/snippet-10.ts
const client = new Glean({
...
```typescript snippet=typescript/snippet-11.ts
const response = await client.client.chat.create(
...
```typescript snippet=typescript/snippet-12.ts
const client = new Glean({
...
```typescript snippet=typescript/snippet-13.ts
const response = await client.client.chat.create(
  { messages: [{ fragments: [{ text: "Hello" }] }] },
  undefined,
  undefined,
...
```typescript snippet=typescript/snippet-14.ts
import express from 'express';
...
```typescript snippet=typescript/snippet-15.ts
...
```typescript snippet=typescript/snippet-16.ts
