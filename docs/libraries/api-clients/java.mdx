...
<Tabs>
  <TabItem value="maven" label="Maven">
    ```xml snippet=java/snippet-01.xml
    <dependency>
...
```java snippet=java/snippet-02.java
...
```java snippet=java/snippet-03.java
...
```java snippet=java/snippet-04.java
...
```java snippet=java/snippet-05.java
@Configuration
...
```java snippet=java/snippet-06.java
@RestController
@RequestMapping("/api")
...
```java snippet=java/snippet-07.java
Glean client = Glean.builder()
...
```yaml snippet=java/snippet-08.yaml
# application.yml
glean:
...
```java snippet=java/snippet-09.java
Glean client = Glean.builder()
...
```java snippet=java/snippet-10.java
...
```yaml snippet=java/snippet-11.yaml
# application.yml
spring:
  security:
    oauth2:
...
```java snippet=java/snippet-12.java
...
```java snippet=java/snippet-13.java
...
```java snippet=java/snippet-14.java
...
```java snippet=java/snippet-15.java
