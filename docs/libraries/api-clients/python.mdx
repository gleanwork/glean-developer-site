...
<Tabs>
  <TabItem value="pip" label="pip">
    ```bash snippet=python/snippet-01.sh
    pip install glean-api-client
    ```
  </TabItem>
  <TabItem value="poetry" label="poetry">
    ```bash snippet=python/snippet-02.sh
    poetry add glean-api-client
    ```
  </TabItem>
  <TabItem value="uv" label="uv">
    ```bash snippet=python/snippet-03.sh
...
<Steps>
  <Step title="Set up environment variables">
    ```bash snippet=python/snippet-04.sh
  ...
  <Step title="Basic usage">
    ```python snippet=python/snippet-05.py
...
```python snippet=python/snippet-06.py
# Simple chat
response = client.client.chat.create(
...
```python snippet=python/snippet-07.py
...
```python snippet=python/snippet-08.py
...
```python snippet=python/snippet-09.py
...
```python snippet=python/snippet-10.py
...
```python snippet=python/snippet-11.py
...
```python snippet=python/snippet-12.py
client = Glean(
...
```python snippet=python/snippet-13.py
response = client.client.chat.create(
...
```python snippet=python/snippet-14.py
client = Glean(
...
```python snippet=python/snippet-15.py
response = client.client.chat.create(
    messages=[{"fragments": [{"text": "Hello"}]}],
...
```python snippet=python/snippet-16.py
import os
...
```python snippet=python/snippet-17.py
...
```python snippet=python/snippet-18.py
import pytest
