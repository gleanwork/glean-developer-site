...
```html snippet=chat/snippet-01.html
<script
    defer
...
```javascript snippet=chat/snippet-02.js
...
<Frame>
  <iframe
    src="https://codepen.io/GleanWork/embed/BaMxWpd?default-tab=js%2Cresult&editable=true&zoom=0.5"
