...
<Steps>
  <Step title="Install the Web SDK">
    ...
    ```bash snippet=default-sso/snippet-01.sh
    npm install @gleanwork/web-sdk
    ```

    Import in your application:

    ```typescript snippet=default-sso/snippet-02.ts
    ...
    ```html snippet=default-sso/snippet-03.html
    <script
      defer
  ...
  <Step title="Render a Component">
    ...
    ```javascript snippet=default-sso/snippet-04.js
    ...
    ```javascript snippet=default-sso/snippet-05.js
    ...
    ```javascript snippet=default-sso/snippet-06.js
...
```javascript snippet=default-sso/snippet-07.js
{
...
```tsx snippet=default-sso/snippet-08.tsx
