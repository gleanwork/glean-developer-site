...
<Steps>
  ...
  <Step title="Download Glean Web Part Code">
    ...
    - **Chat Web Part**: Download from [web-sdk-embed-examples/sharepoint-webpart-chat](https://github.com/gleanwork/web-sdk-embed-examples/tree/main/sharepoint-webpart-search)
  </Step>
</Steps>
