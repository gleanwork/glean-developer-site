...
To integrate Glean's modal search interface into your LumApps environment, add custom code to your site's `<head>`. In your LumApps site settings, open **Style** > **Advanced** and paste the code into **Head tag (HTML)**. See LumApps' [customization deployment guide](https://lumapps.github.io/customizations-api-doc/javascript/development-and-deployment.html).
