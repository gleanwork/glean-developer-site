...
<Steps>
  <Step title="Access Theme Customization">
    In **Knowledge admin**, click **Customize design** in the left navigation
  </Step>
  ...
  <Step title="Edit Theme Code">
    ...
    ```javascript script.js snippet=zendesk/snippet-01.js
...
<Steps>
  <Step title="Import JavaScript Files">
    ...
    2. Click **Edit Code**
    3. Open **document_head.hbs**
    4. Add the following script tag:

    ```hbs document_head.hbs
  ...
  <Step title="Initialize Glean Search">
    ...
    ```javascript script.js snippet=zendesk/snippet-02.js
    /** Setup Glean search **/
