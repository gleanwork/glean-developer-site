...
### hideUnconfigurableDatasources?

```ts
optional hideUnconfigurableDatasources?: boolean;
```

Controls whether a user sees admin-managed data sources that they cannot configure.
