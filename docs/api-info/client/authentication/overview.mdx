...
### Choose OAuth if you:
- Want standards-based, user-authorized access without manually managing Glean API tokens
- Can enable the Glean OAuth Authorization Server, or already use supported OAuth tokens from your enterprise identity provider
