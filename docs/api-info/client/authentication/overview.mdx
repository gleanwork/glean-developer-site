...
<Tabs>
<TabItem value="oauth-gas" label="Glean OAuth Authorization Server">
...
<TabItem value="oauth-idp" label="External IdP OAuth">

```bash snippet=overview/snippet-02-idp.sh
Authorization: Bearer <oauth_access_token>
...
```bash snippet=overview/snippet-05-idp.sh
curl -X POST https://<instance>-be.glean.com/rest/api/v1/search \
  -H 'Authorization: Bearer <OAUTH_TOKEN>' \
