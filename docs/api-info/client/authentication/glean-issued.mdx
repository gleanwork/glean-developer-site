...
<Tabs>
  ...
  ```bash snippet=glean-issued/snippet-01.sh
  ...
  ```bash snippet=glean-issued/snippet-02.sh
...
```bash snippet=glean-issued/snippet-03.sh
...
```bash snippet=glean-issued/snippet-04.sh
curl -X POST https://instance-be.glean.com/rest/api/v1/search \
...
```bash snippet=glean-issued/snippet-05.sh
curl -X POST https://instance-be.glean.com/rest/api/v1/search \
  -H 'Authorization: Bearer <USER_TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{
...
```bash snippet=glean-issued/snippet-06.sh
curl -X POST https://instance-be.glean.com/rest/api/v1/search \
  -H 'Authorization: Bearer <GLOBAL_TOKEN>' \
  -H 'X-Glean-ActAs: user@company.com' \
  -H 'Content-Type: application/json' \
...
```bash snippet=glean-issued/snippet-07.sh
...
<Tabs>
  ...
  ```bash snippet=glean-issued/snippet-08.sh
  curl -X POST https://<instance>-be.glean.com/rest/api/v1/search \
    -H 'Authorization: Bearer <USER_TOKEN>' \
    -H 'Content-Type: application/json' \
  ...
  ```bash snippet=glean-issued/snippet-09.sh
  curl -X POST https://<instance>-be.glean.com/rest/api/v1/search \
    -H 'Authorization: Bearer <GLOBAL_TOKEN>' \
...
```json snippet=glean-issued/snippet-10.json
{
  "results": [...],
  "trackingToken": "...",
  "requestId": "..."
