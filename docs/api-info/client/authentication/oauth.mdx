...
- **Scope**: Full Client API access, unless your administrator restricts the integration to specific [scopes](/api-info/client/authentication/glean-issued)
...
- **Cache tokens** to reduce calls to the issuer, and refresh before expiry
