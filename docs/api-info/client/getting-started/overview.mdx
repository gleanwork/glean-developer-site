...
<Card title="Generative AI Chat" icon="chat" iconSet="glean">
  Build conversational interfaces using Glean's AI that understands your
  organization's specific context and content
</Card>

<Card title="Document Access" icon="File">
  Retrieve document content, metadata, activity tracking, and permissions-aware
...
<Step title="Choose Your Approach">
  Select your development approach: - **Official SDKs**: Use our [Python, Java,
  NodeJS, or Go SDKs](../../../libraries/api-clients) for faster development -
  **Direct REST API**: Make HTTP requests directly for maximum flexibility -
  **Web SDK**: Embed pre-built UI components using our [Web
  SDK](../../../libraries/web-sdk/overview)
</Step>

<Step title="Start Building">
  Begin with core functionality using our [Basic Usage Guide](basic-usage): -
  Try basic search queries to understand result formats - Experiment with chat
  endpoints for conversational features - Test document retrieval and permission
  handling - Explore content creation endpoints (collections, answers)
</Step>
