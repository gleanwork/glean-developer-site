...
**Request Format:**
```bash showLineNumbers snippet=basic-usage/snippet-01.sh
...
**Response Structure:**
```json showLineNumbers snippet=basic-usage/snippet-02.json
{
  "messages": [
    {
      "messageType": "CONTENT", 
...
**Response Structure:**
```json showLineNumbers snippet=basic-usage/snippet-04.json
{
  "results": [
    {
      ...
      "snippets": [
        { "snippet": "Our Q4 objectives focus on...", "mimeType": "text/plain" }
      ],
      "metadata": {
  ...
  "facetResults": [
    {
      ...
      "buckets": [
        { "value": { "stringValue": "confluence" }, "count": 15 },
        { "value": { "stringValue": "gdrive" }, "count": 8 }
      ]
    }
  ],
  "trackingToken": "...",
...
**Request Format:**
```bash showLineNumbers snippet=basic-usage/snippet-05.sh
...
**Response Structure:**
```json showLineNumbers snippet=basic-usage/snippet-06.json
{
  "run": {
    "agent_id": "your-agent-id",
    "input": {
...
```bash showLineNumbers snippet=basic-usage/snippet-07.sh
curl -X POST https://your-instance-be.glean.com/rest/api/v1/search \
  -H 'Authorization: Bearer <your_token>' \
  -H 'Content-Type: application/json' \
  -d '{
...
```bash showLineNumbers snippet=basic-usage/snippet-08.sh
curl -X POST https://your-instance-be.glean.com/rest/api/v1/chat \
  -H 'Authorization: Bearer <your_token>' \
  -H 'Content-Type: application/json' \
  -d '{
...
```bash showLineNumbers snippet=basic-usage/snippet-09.sh
# First message
curl -X POST https://your-instance-be.glean.com/rest/api/v1/chat \
  -H 'Authorization: Bearer <your_token>' \
  -H 'Content-Type: application/json' \
...
```bash showLineNumbers snippet=basic-usage/snippet-10.sh
curl -X POST https://your-instance-be.glean.com/rest/api/v1/search \
  -H 'Authorization: Bearer <your_token>' \
  -H 'Content-Type: application/json' \
  -d '{
...
```bash showLineNumbers snippet=basic-usage/snippet-11.sh
curl -X POST https://your-instance-be.glean.com/rest/api/v1/search \
  -H 'Authorization: Bearer <your_token>' \
  -H 'Content-Type: application/json' \
  -d '{
...
```bash showLineNumbers snippet=basic-usage/snippet-12.sh
curl -X POST https://your-instance-be.glean.com/rest/api/v1/chat \
  -H 'Authorization: Bearer <your_token>' \
  -H 'Content-Type: application/json' \
  -d '{
...
<CardGroup cols={2}>
  ...
  <Card title="Streaming Chat cookbook" icon="Info" href="/cookbook/streaming-chat-with-citations">
    Build a cited, permission-aware Chat CLI with streaming responses
  </Card>
