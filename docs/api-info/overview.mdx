...
<CardGroup cols={3}>
  <Card title="Platform API" icon="Zap" iconSet="feather" href="/api/platform-api">
  ...
  <Card title="Client API" icon="Code" iconSet="feather" href="/api/client-api">
    Build user-facing experiences with existing search, chat, content, and specialized REST capabilities.
  </Card>

  <Card title="Indexing API" icon="Database" iconSet="feather" href="/api/indexing-api">
