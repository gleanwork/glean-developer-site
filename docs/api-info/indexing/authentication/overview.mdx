...
```bash snippet=overview/snippet-08.sh
...
```bash snippet=overview/snippet-09.sh
...
**Response**
```json snippet=overview/snippet-10.json
{
  "rawSecret": "new-rotated-token-value",
  "createdAt": 1735689599,
...
```bash snippet=overview/snippet-11.sh
Authorization: Bearer <indexing_api_token>
```
...
```bash snippet=overview/snippet-12.sh
...
```bash snippet=overview/snippet-13.sh
...
<TabItem value="datasource-config" label="Get Datasource Config">

```bash snippet=overview/snippet-14.sh
...
```bash snippet=overview/snippet-15.sh
...
```bash snippet=overview/snippet-16.sh
curl -X POST https://<instance>-be.glean.com/api/index/v1/getdatasourceconfig \
...
```json snippet=overview/snippet-17.json
{
  "name": "my-datasource",
  "displayName": "My Datasource",
  "urlRegex": "https://internal.example.com/.*"
}
```
...
```bash snippet=overview/snippet-18.sh
curl -X POST https://<instance>-be.glean.com/api/index/v1/indexdocument \
  -H 'Authorization: Bearer <YOUR_INDEXING_TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{
