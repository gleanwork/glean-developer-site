...
For more details on how to use the Indexing API to start indexing a custom datasource, refer to the [Indexing API Quickstart](/api-info/indexing/getting-started/overview).
