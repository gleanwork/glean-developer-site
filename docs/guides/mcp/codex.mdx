      ...
      steps={[
        {
          ...
          description:
            "The plugin requires a Glean MCP connection. Open the Glean MCP configurator and copy your organization's full server URL — you'll use it in the last step.",
        ...
        },
        {
          ...
          description:
            'Before starting Codex, connect the MCP server — substitute the full server URL you copied in step 1. Then start a new Codex task so the bundled skills and MCP tools are available.',
          commands: [
            {
              title: 'Connect and sign in',
              code: 'codex mcp add glean --url <server-url>\ncodex mcp login glean',
            },
          ],
        },
      ]}
  ...
  <PluginPage
    ...
    steps={[
      ...
      },
      {
        ...
        items: [
          <>
            In Codex, prompt: <code>Set up Glean for me</code>
          </>,
