...
<CardGroup cols={2}>
  ...
  <Card 
    title="Streaming Chat cookbook"
    icon="MessageCircle"
    href="/cookbook/streaming-chat-with-citations"
  >
...
1. **Start Simple**: Begin with the [Streaming Chat cookbook](/cookbook/streaming-chat-with-citations)
