...
Follow the steps in [Glean Documentation](https://docs.glean.com/administration/actions/setup-actions/jira-actions-setup#creating-a-custom-oauth-app) to set up authentication for Jira.
