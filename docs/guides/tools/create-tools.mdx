...
<CardGroup cols={3}>
  <Card title="Chat" icon="chat" iconSet="glean">
  ...
  <Card title="Glean MCP Server" icon="mcp" iconSet="glean">
...
For an example custom tool built from an OpenAPI spec, see [Custom tools](https://docs.glean.com/tools/custom) in the Glean documentation.
