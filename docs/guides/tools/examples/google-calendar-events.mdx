---
title: Google Calendar Events Retrieval Tool
...
<Steps>
  <Step title="Creating the Base Tool">
  ...
  <Step title="Configuring the API Specification">
    ...
    ```yaml snippet=google-calendar-events/snippet-01.yaml
    openapi: 3.0.1
    servers:
  ...
  <Step title="Testing and Deployment">
    ...
    2. You'll see the connection banner:
       ...
       [![Connect Tool Banner](./images/google-calendar-events/calendar_action_connect_banner.png)](./images/google-calendar-events/calendar_action_connect_banner.png)
    ...
    [![Deploy Tool View](./images/google-calendar-events/deploy_window.png)](./images/google-calendar-events/deploy_window.png)
