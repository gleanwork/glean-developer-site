---
title: Jira Issue Creation Using Redirect Tool
...
# Jira Issue Creation Using Redirect Tool
...
<Steps>
  <Step title="API Specification Development">
    <p>The OpenAPI specification serves as the blueprint for how Glean Assistant interacts with your redirect tool. This specification must clearly define all parameters and their behaviors to ensure accurate field population.</p>

    <details>
      <summary>Click to expand the complete OpenAPI specification</summary>

    ```yaml snippet=jira-issue-creation-redirect/snippet-01.yaml
    openapi: '3.0.0'
    info:
  ...
  <Step title="Testing and Deployment">
    <p>After configuration, thoroughly test the redirect tool before deployment.</p>
