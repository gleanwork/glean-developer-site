...
<details>
<summary>How to authenticate Tools built using Glean's Jira template?</summary>
...
```yaml snippet=faq/snippet-01.yaml
description:
...
```yaml snippet=faq/snippet-02.yaml
assignee:
...
```yaml snippet=faq/snippet-03.yaml
components:
...
```yaml snippet=faq/snippet-04.yaml
issue:
...
```yaml snippet=faq/snippet-05.yaml
priority:
...
```yaml snippet=faq/snippet-06.yaml
issue_type:
...
```yaml snippet=faq/snippet-07.yaml
pid:
...
```yaml snippet=faq/snippet-08.yaml
jiraTicketUrl:
...
<details>
<summary>Do Tools work for endpoints behind VPN?</summary>
...
<details>
<summary>How much data can my service return (for retrieval tools)?</summary>
