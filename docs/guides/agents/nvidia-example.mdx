...
1. Set the following environment variables:
   ...
   ```bash snippet=nvidia-example/snippet-01.sh
   export GLEAN_API_KEY="YOUR GLEAN API KEY"
   export GLEAN_API_BASE_URL="https://your-instance-be.glean.com/rest/api/v1"
...
2. Create a python file called `chatbot.py` to instantiate the LLM and embedding model:
   ...
   ```python snippet=nvidia-example/snippet-02.py
   import os
...
3. Ask the foundational LLM a test question by modifying `chatbot.py`, adding the following lines and running it:
   ...
   ```python snippet=nvidia-example/snippet-03.py
...
```python snippet=nvidia-example/snippet-04.py
...
```python snippet=nvidia-example/snippet-05.py
...
```python snippet=nvidia-example/snippet-06.py
...
```python snippet=nvidia-example/snippet-07.py
