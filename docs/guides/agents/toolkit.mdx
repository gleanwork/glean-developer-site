...
```python snippet=toolkit/snippet-01.py
...
```python snippet=toolkit/snippet-02.py
...
```python snippet=toolkit/snippet-03.py
...
```python snippet=toolkit/snippet-04.py
...
```python snippet=toolkit/snippet-05.py
...
```python snippet=toolkit/snippet-06.py
from glean.agent_toolkit.tools import search, employee_search
from glean.agent_toolkit import tool_spec
...
```python snippet=toolkit/snippet-07.py
