...
<CardGroup cols={2}>
  ...
  >
    ```bash snippet=direct-api/snippet-01.sh
  ...
  >
    ```bash snippet=direct-api/snippet-02.sh
  ...
  >
    ```bash snippet=direct-api/snippet-03.sh
  ...
  >
    ```xml snippet=direct-api/snippet-04.xml
    <dependency>
...
```python snippet=direct-api/snippet-05.py
import os
...
```python snippet=direct-api/snippet-06.py
import os
from glean.api_client import Glean, models
...
### Error Handling
```python snippet=direct-api/snippet-07.py
...
### Caching Results
```python snippet=direct-api/snippet-08.py
import hashlib
import json
...
### Rate Limiting
```python snippet=direct-api/snippet-09.py
import time
from datetime import datetime, timedelta
