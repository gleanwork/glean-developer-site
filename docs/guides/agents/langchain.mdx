...
<Tabs>
  ...
  ```bash  snippet=langchain/snippet-01.sh
  ...
  ```bash  snippet=langchain/snippet-02.sh
  ...
  ```bash  snippet=langchain/snippet-03.sh
...
```bash snippet=langchain/snippet-04.sh
...
```python snippet=langchain/snippet-05.py
...
```python snippet=langchain/snippet-06.py
...
```python snippet=langchain/snippet-07.py
...
```python snippet=langchain/snippet-08.py
...
```python snippet=langchain/snippet-09.py
