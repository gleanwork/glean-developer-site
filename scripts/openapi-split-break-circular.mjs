...
class DeterministicCircularResolver {
    ...
    resolveSchemaWithSelectiveInlining(schemaName, allSchemas, visited, depth = 0, inArray = false) {
        ...
        try {
            const resolved = this.resolveSchemaObjectSelectively(schema, allSchemas, visited, depth, inArray, isCircular);
    ...
    resolveSchemaObjectSelectively(obj, allSchemas, visited, depth = 0, inArray = false, isCircular = false) {
        ...
        if (obj.type === 'array' && 'items' in obj) {
            resolved['type'] = 'array';
            const resolvedItems = this.resolveSchemaObjectSelectively(obj['items'], allSchemas, visited, depth + 1, true, isCircular);
            ...
            for (const propName of Object.keys(obj['properties']).sort()) {
                ...
                try {
                    resolved['properties'][propName] = this.resolveSchemaObjectSelectively(
                        propDef, allSchemas, visited, depth + 1, false, isCircular
                    );
                } catch (e) {
        ...
        if ('allOf' in obj) {
            ...
            for (let i = 0; i < obj['allOf'].length; i++) {
                ...
                try {
                    const resolvedSub = this.resolveSchemaObjectSelectively(subSchema, allSchemas, visited, depth + 1, false, isCircular);
        ...
        if ('oneOf' in obj) {
            ...
            for (let i = 0; i < obj['oneOf'].length; i++) {
                ...
                try {
                    resolved['oneOf'].push(this.resolveSchemaObjectSelectively(subSchema, allSchemas, visited, depth + 1, false, isCircular));
                } catch (e) {
        ...
        if ('anyOf' in obj) {
            ...
            for (let i = 0; i < obj['anyOf'].length; i++) {
                ...
                try {
                    resolved['anyOf'].push(this.resolveSchemaObjectSelectively(subSchema, allSchemas, visited, depth + 1, false, isCircular));
                } catch (e) {
