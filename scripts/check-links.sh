...
# Please include a comment with context for each exclusion.
#
# Format: --exclude "^https://..." # REASON: [explanation] (added YYYY-MM-DD)
lychee_cmd+=(
  --exclude "^https://developers\.glean\.com/docs/migrations/2027-01-15" # REASON: Future migration guide page not yet published (added 2025-12-16)
)
