  ...
  <Tab title="Configure using the CLI (OAuth)">
    <Steps>
      ...
      <Step title="Configure Cursor">
        ...
        ```bash
        npx @gleanwork/configure-mcp-server --client cursor --instance <your-glean-instance-name>
        ```
      </Step>
  ...
  <Tab title="Configure using the CLI (Token)">
    <Steps>
      ...
      <Step title="Configure Cursor">
        ...
        ```bash
        npx @gleanwork/configure-mcp-server --client cursor --instance <your-glean-instance-name> --token <your-glean-api-token>
        ```

        Using a `.env` file:
        ```bash
        npx @gleanwork/configure-mcp-server --client cursor --env <path-to-env-file>
        ```
      </Step>
  ...
  <Tab title="Configure using the CLI (OAuth)">
    <Steps>
      ...
      <Step title="Configure Windsurf">
        ...
        ```bash
        npx @gleanwork/configure-mcp-server --client windsurf --instance <your-glean-instance-name>
        ```
      </Step>
  ...
  <Tab title="Configure using the CLI (Token)">
    <Steps>
      ...
      <Step title="Configure Windsurf">
        ...
        ```bash
        npx @gleanwork/configure-mcp-server --client windsurf --instance <your-glean-instance-name> --token <your-glean-api-token>
        ```

        Using a `.env` file:
        ```bash
        npx @gleanwork/configure-mcp-server --client windsurf --env <path-to-env-file>
        ```
      </Step>
      <Step title="Test the Integration">
        <Note>
      ...
      <Tab title="Configure using the CLI (OAuth)">
        <Steps>
          ...
          <Step title="Configure VS Code">
            ...
            ```bash
            npx @gleanwork/configure-mcp-server --client vscode --instance <your-glean-instance-name>
            ```
          </Step>
      ...
      <Tab title="Configure using the CLI (Token)">
        <Steps>
          ...
          <Step title="Configure VS Code">
            ...
            Using explicit `instance` and `token` flags:
            ```bash
            npx @gleanwork/configure-mcp-server --client vscode --instance <your-glean-instance-name> --token <your-glean-api-token>
            ```

            Using a `.env` file:
            ```bash
            npx @gleanwork/configure-mcp-server --client vscode --env <path-to-env-file>
            ```
          </Step>
      ...
      <Tab title="Configure using the CLI (OAuth)">
        <Steps>
          ...
          <Step title="Configure VS Code">
            ...
            ```bash
            npx @gleanwork/configure-mcp-server --client vscode --instance <your-glean-instance-name> --workspace
            ```
          </Step>
      ...
      <Tab title="Configure using the CLI (Token)">
        <Steps>
          ...
          <Step title="Configure VS Code">
            ...
            Using explicit `instance` and `token` flags:
            ```bash
            npx @gleanwork/configure-mcp-server --client vscode --instance <your-glean-instance-name> --token <your-glean-api-token> --workspace
            ```

            Using a `.env` file:
            ```bash
            npx @gleanwork/configure-mcp-server --client vscode --env <path-to-env-file> --workspace
            ```
          </Step>
  ...
  <Tab title="Configure using the CLI (OAuth)">
    <Steps>
      ...
      <Step title="Configure Claude Desktop">
        ...
        ```bash
        npx @gleanwork/configure-mcp-server --client claude --instance <your-glean-instance-name>
        ```
      </Step>
  ...
  <Tab title="Configure using the CLI (Token)">
    <Steps>
      ...
      <Step title="Configure Claude Desktop">
        ...
        Using explicit `domain` and `token` flags:
        ```bash
        npx @gleanwork/configure-mcp-server --client claude --instance <your-glean-instance-name> --token <your-glean-api-token>
        ```

        Using a `.env` file:
        ```bash
        npx @gleanwork/configure-mcp-server --client claude --env <path-to-env-file>
        ```
      </Step>
      <Step title="Test the Integration">
        <Note>
