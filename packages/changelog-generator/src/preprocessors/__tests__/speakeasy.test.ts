...
describe('parseSpeakeasyNotes', () => {
  ...
  it('repairs an unclosed response content media type path', () => {
    const changes = parseSpeakeasyNotes(`# Generated by Speakeasy CLI
## Go SDK Changes:
...
`);
    ...
    expect(changes).toEqual([
      {
        method: 'Glean.Chat.Create()',
        field: 'response.status[200].content[text/event-stream]',
        action: 'removed',
      },
    ]);
  });
