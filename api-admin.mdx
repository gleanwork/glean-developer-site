...
See [Creating a Policy](https://developers.glean.com/api-reference/client/governance/creates-new-policy) for detailed specs.
...
See [Updating a Policy](https://developers.glean.com/api-reference/client/governance/updates-an-existing-policy) for detailed specs.
...
See [Get a Policy](https://developers.glean.com/api-reference/client/governance/gets-specified-policy) for detailed specs.
...
See [Listing Policies](https://developers.glean.com/api-reference/client/governance/lists-policies) for detailed specs.
...
See [Download Policy Violations](hhttps://developers.glean.com/api-reference/client/governance/downloads-violations-csv-for-policy) for detailed specs.
...
See [Creating a Report](https://developers.glean.com/api-reference/client/governance/creates-new-one-time-report) for detailed specs.
...
See [Get Report Status](https://developers.glean.com/api-reference/client/governance/fetches-report-run-status) for detailed specs.

### Downloading Report violations.

This will download a CSV file of all the violations of a specific report.

See [Download Report Violations](https://developers.glean.com/api-reference/client/governance/downloads-violations-csv-for-report) for detailed specs.
...
See [Hide/Unhide Documents](https://developers.glean.com/api-reference/client/governance/hideun-hide-docs) for detailed specs.
...
See [Get Document Visibility](https://developers.glean.com/api-reference/client/governance/fetches-documents-visibility) for detailed specs.
