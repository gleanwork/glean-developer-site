...
<Frame>
  <img
    src="./images/third_party_cookies/3P-cookie-request.png"
    alt="Glean 3P Cookie Access Request"
  />
</Frame>
...
<Frame caption="Browser prompt for third-party cookie access">
  <img
    src="./images/third_party_cookies/3P-cookie-browser-prompt.png"
    alt="Browser 3P Cookie Access Prompt"
  />
</Frame>
